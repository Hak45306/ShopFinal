	...
	<div class="container" style="min-height: 760px; min-width: auto;">
		...
		<div class="col-8 offset-2 bg-light">
			<form method="post" action="<spring:url value="/admin/sanpham/add" />">
				<div class="row mt-2">
					<div class="col-6">
						<label>Sản phẩm</label> <input type="text" name="name" class="form-control list-inline-item" />
					</div>
					<div class="col-6">
						<label>Số lượng</label> <input type="text" name="price" class="form-control" />
					</div>
				</div>
				<div class="row mt-2">
					<div class="col-6">
						<label>Đơn giá</label> <input type="text" name="soluong" class="form-control" />
					</div>
					<div class="col-6">
						<label>Tình trạng</label> <input type="file" name="img" class="form-control" />
					</div>
				</div>
				<div class="row mt-2">
					</br>
