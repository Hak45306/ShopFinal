...
-- Dumping data for table webstore.danhmuc: ~8 rows (approximately)
...
-- Dumping data for table webstore.giohang: ~6 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `hoadon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `iduser` int(11) DEFAULT NULL,
  `mahd` char(50) DEFAULT NULL,
  `trangthai` int(11) DEFAULT NULL,
  `tongtien` double(20,0) DEFAULT NULL,
...
-- Dumping data for table webstore.hoadon: ~2 rows (approximately)
REPLACE INTO `hoadon` (`id`, `iduser`, `mahd`, `trangthai`, `tongtien`, `ngaytao`, `ngaysua`, `ngaythanhtoan`, `ngayship`, `ngaynhan`) VALUES
	(13, 57, '100577757213229061', 1, NULL, '2023-11-14', NULL, NULL, NULL, NULL),
	(14, 58, '100577757213229062', 1, NULL, '2023-11-14', NULL, NULL, NULL, NULL);

-- Dumping structure for table webstore.hoadonchitiet
DROP TABLE IF EXISTS `hoadonchitiet`;
CREATE TABLE IF NOT EXISTS `hoadonchitiet` (
  `idhd` int(11) NOT NULL,
  `idpro` int(11) NOT NULL,
  `dongia` double(20,0) NOT NULL,
  `soluong` int(11) NOT NULL,
  `thanhtien` double(20,0) DEFAULT NULL,
  PRIMARY KEY (`idhd`,`idpro`),
  KEY `FK_hoadonchitiet_sanpham` (`idpro`),
  CONSTRAINT `FK_hoadonchitiet_hoadon` FOREIGN KEY (`idhd`) REFERENCES `hoadon` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_hoadonchitiet_sanpham` FOREIGN KEY (`idpro`) REFERENCES `sanpham` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table webstore.hoadonchitiet: ~9 rows (approximately)
REPLACE INTO `hoadonchitiet` (`idhd`, `idpro`, `dongia`, `soluong`, `thanhtien`) VALUES
	(13, 86, 9990, 10, NULL),
	(13, 87, 6392, 8, NULL),
	(13, 111, 420, 7, NULL),
	(14, 86, 10989, 11, NULL),
...
-- Dumping data for table webstore.taikhoan: ~3 rows (approximately)
REPLACE INTO `taikhoan` (`id`, `user`, `pass`, `email`, `address`, `tel`, `role`) VALUES
	...
	(57, 'oniha', '1234', 'oni@gmail.com', 'Hà Nội', '089654123', 'USER'),
