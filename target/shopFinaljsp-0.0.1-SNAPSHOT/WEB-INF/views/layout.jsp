...
<header class="p-2 bg-dark text-white">
  ...
  <path
			...
			<ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
				...
				<li><a href="#" class="nav-link px-2 text-white">${session.username}</a></li>
			</ul>
			<div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
				<div class="d-flex float-end">
					<div class="me-1 rounded py-1 px-3 nav-link d-flex align-items-center">
						<div class="input-group float-center">
							...
							<button type="button" class="btn btn-dark border shadow-0">
	...
	fill: #ffffff
					...
					<div class="dropdown me-1 border rounded py-1 px-3 nav-link d-flex align-items-center">
						<a href="<c:url value="/login" />"
							class="d-block link-light text-decoration-none dropdown-toggle" id="dropdownUser1"
