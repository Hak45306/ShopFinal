					...
					<div class="card bg-dark text-white" style="border-radius: 1rem;">
						<div class="card-body p-5 text-center">
							<div class="mb-md-5 mt-md-4 pb-5">
								...
								<form action="/shopFinaljsp/register" method="post" class="form-horizontal">
									...
									<div class="form-outline form-white mb-4">
										<input type="password" id="typePasswordX" name="password"
											class="form-control form-control-lg" /> <label class="form-label" for="typePasswordX">Password</label>
									</div>
									<div class="form-outline form-white mb-4">
										<input type="tel" id="typePhonenumberX" name="phonenumber"
											class="form-control form-control-lg" /> <label class="form-label" for="typePhonenumberX">Phone
											number</label>
									</div>
									<div class="form-outline form-white mb-4">
							...
							<div>
								<p class="mb-0">
									You already have an account? <a href="<c:url value="/login" />"
